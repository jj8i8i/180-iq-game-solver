...
class Solver {
    ...
    solve() {
        ...
        // The final de-duplication is now handled robustly by the UI
    ...
    find(items) {
        ...
        // --- THE ULTIMATE FIX: Canonical Key for Memoization ---
    ...
    tryOp(a, b, op, remaining) {
        ...
        if ((op === '*' || op === '+') && (b.str < a.str)) { inputs = [b,a]; a = inputs[0]; b = inputs[1]; }
